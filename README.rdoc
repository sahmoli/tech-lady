...
We use ruby version +1.9.3p194+, you can use RVM to help you install ruby.

* RVM url: https://rvm.io
...
* If you don't have RubyGems installed, please install it first.
